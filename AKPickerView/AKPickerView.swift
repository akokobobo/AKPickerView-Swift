...
@objc public protocol AKPickerViewDataSource {
	...
	@objc optional func pickerView(_ pickerView: AKPickerView, titleForItem item:Int) -> NSString
...
open class AKPickerView: UIView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, AKCollectionViewLayoutDelegate {
	...
	open var dataSource: AKPickerViewDataSource? = nil
	/// Readwrite. Delegate of picker view.
	open var delegate: AKPickerViewDelegate? = nil {
		didSet(delegate) {
	...
	open lazy var textColor = UIColor.darkGray
	/// Readwrite. A color of the text on selected cells.
	open lazy var highlightedTextColor = UIColor.black
	...
	open var viewDepth: CGFloat = 1000.0 {
		didSet {
